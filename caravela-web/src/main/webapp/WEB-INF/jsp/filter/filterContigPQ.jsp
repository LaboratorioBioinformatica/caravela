...
<t:default>
	...
	<div class="container">
		<div class="page-header">
			<h1>Filter contigs PQ</h1>
			<hr>
			<h3>Sample: <strong>${sample.name}</strong></h3>
		</div>
		
		<div class="form-group">
					<form action="<c:url value="/filter/contig/pq"/>" class="form-horizontal" role="form" method="post">
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<fmt:formatNumber type="number" maxIntegerDigits="3" value="${filterPQParameters.itg}" var="ITGFormated" />
								<input class="form-control" value="${ITGFormated}" size="3" maxlength="3"  type="text" id="ITG" name="filterPQParameters.itg">
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<input class="form-control" value="${filterPQParameters.numberOfFeatures}" size="4" maxlength="4" min=0 type="number" id="numberOfFeatures" name="filterPQParameters.numberOfFeatures">
							</div>
							<span class="col-sm-6"></span>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								 <select class="form-control" name="filterPQParameters.taxonomicRank" id="selectRank">
								 
									  <option value="SPECIES" ${filterPQParameters.taxonomicRank eq "SPECIES" ? 'selected="selected"' : ''}>SPECIES</option>
									  <option value="GENUS" ${filterPQParameters.taxonomicRank eq "GENUS" ? 'selected="selected"' : ''}>GENUS</option>
									  <option value="FAMILY" ${filterPQParameters.taxonomicRank eq "FAMILY" ? 'selected="selected"' : ''}>FAMILY</option>
						...
						<div class="form-group">
								<label for="numberOfBorders" class="col-sm-4 control-label">Borders: ( &ge; )</label>
							...
							<div class="col-sm-2">
								<input class="form-control" value="${filterPQParameters.numberOfBorders}" size="4" maxlength="2" min=0 type="number" id="numberOfBorders" name="filterPQParameters.numberOfBorders">
							</div>
							<span class="col-sm-6"></span>
						</div>
						
						<div class="form-group">
								<label for="ICTCRGreaterOrEqualsThan" class="col-sm-2 control-label">CT: ( &le; )</label>
							<div class="col-sm-2">
								<fmt:formatNumber type="number" maxIntegerDigits="4" value="${filterPQParameters.ct}" var="CTFormated" />
								<input class="form-control" value="${CTFormated}" size="4" maxlength="4" type="text" id="CT" name="filterPQParameters.ct">
							</div>
							<div class="col-sm-2">
							...
							<label for="IVCTGreaterOrEqualsThan" class="col-sm-2 control-label">CTV: ( &le; )</label>
							<div class="col-sm-2">
								<fmt:formatNumber type="number" maxIntegerDigits="4" value="${filterPQParameters.ctv}" var="CTVFormated" />
								<input class="form-control" value="${CTVFormated}" size="4" maxlength="4"  type="text" id="CTV" name="filterPQParameters.ctv">
						...
						<div class="form-group">
							<div class="col-sm-12 center-block">
								...
								<a class="btn btn-default right-block" href="<c:url value="/filter/contig/pq/view/${sample.id}"/>" role="button">Default values</a>
							</div>
